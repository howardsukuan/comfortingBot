...
handleSoruceDICT = {"appearance":["appearance","身體","顏值","身高","體重","額頭","髮質","髮際","髮際線","臉","眼袋","眉毛","鼻子","嘴唇","下巴","雙下巴","耳朵","脖子","手","手臂","手肘","胸部","皮膚","皺紋","斑","痣","肚子大","肚子凸","小腹","腰","肚臍","腿","大腿","小腿","膚色","屁股"],
                    ...
                    "family": ["family","趕出家門","爸爸","爸","媽媽","媽","父親","母親","哥哥","哥","大哥","姊姊","姊","姐姐","姐","大姊","大姐","弟弟","弟","小弟","妹妹","妹","小妹","親戚","親戚們","外公","外婆","爺爺","奶奶","公公","婆婆","公婆","兒子","女兒","阿公","阿嬤","被家人氣死","被爸媽氣死","氣死", "男朋友", "女朋友", "家裡的人","女友","男友","我","家人","阿公","阿嬤","叔","阿姨","舅","舅媽","伯","姑","先生","太太","老公","老婆","同居人"],
