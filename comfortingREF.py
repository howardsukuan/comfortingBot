...
sourceReactionDICT = {"appearance":["大家對外表可能會有一定的要求,但是重點還是在你身上,如果你喜歡這樣的自己,那又何嘗不可?"," 外表只是一時的，只要健康就好","美醜其實都是自己定義的！所以抬頭挺胸，做自信的自己！我相信你可以！","比起皮囊，我更喜歡那裡頭的靈魂。", "不論身心靈各方面，多愛自己一點是基本呀!!!"],
                    "negMood":["雖說自己的努力不用別人去定義，但現在這個受委屈的心情是真實的，我懂你的不舒服，但現在的繼續努力，未來我相信一定會成為支持你的力量", "遇到難解之事，都會在心裡跟自己說: 我是大人 我是大人 我是大人了啊 咩噗!!!","我不會叫你加油，因為我知道你已經很努力了。"],
                    ...
                    "thesis":["按照自己的步調來，穩穩地走！","每個人都有自己的路和步調，沒有所謂最正確或最快速，只有最適合自己的那種。"],
                    ...
                    "notDone":["一步一步就可以把手上的事情都做完了！","雖然看似超級多，但一點一點做，一定可以完成的~","我也很討厭事情做不完這種感覺，因為覺得壓力很大啊！但我想和你說，我相信你的能力，按部就班，絕對可以做完的！","手邊事情繁雜的時候真的很不好受，記得要適度休息喔！現在就先喝個水吧！"],
