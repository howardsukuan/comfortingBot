...
handleSoruceDICT = {"appearance":["appearance","身體","顏值","身高","體重","額頭","髮質","髮際","髮際線","臉","眼袋","眉毛","鼻子","嘴唇","下巴","雙下巴","耳朵","脖子","手","手臂","手肘","胸部","皮膚","皺紋","斑","痣","肚子","小腹","腰","肚臍","腿","大腿","小腿","膚色","屁股"],
                    ...
                    "schoolwork":["作業","作品","schoolwork","homework","分組","報告","分工","呈現","期中","期末"],
                    "colleagueRelation":["同事","同事們","夥伴","前輩","新鮮人","相處","共事"],
                    "colleagueLEI":["colleagueLEI","雷同事","馬屁精","雙面人","小人","偷懶","不做事","被幹掉","被做掉","講壞話","八卦","拍馬屁","來陰的","被弄"],
                    "weather":["天氣","weather","大太陽","颳風","下雨","毛毛雨","暴雨","午後雷陣雨","打雷","陰陰的","霧霾","濕氣","酷熱","熱","冷"],
                    "family": ["爸爸","媽媽","父親","母親","哥哥","大哥","姊姊","姐姐","大姊","大姐","弟弟","小弟","妹妹","小妹","親戚們","外公","外婆","爺爺","奶奶","公公","婆婆","公婆","兒子","女兒"],
                    "money":["錢","money","薪水","薪資","投資","股票","基金","花錢","存錢","存款","存不到錢","月光","信用卡費","帳單","紅利"],
                    "death":["death","死","死亡","死掉","過世","去世","翹翹","不在了","考試","喪禮","法會","頭七"],
                    "sick":["sick","生病","嘔吐","頭暈","痠痛","痠","痛","牙痛","頭痛","腳痛","膝蓋痛","咳嗽","乾咳","心悸"],
                    "self":["我","自己","個人","一個人"],
                    "stranger":["人","stranger","陌生人","路人","有人"],
                    "food":["food","食物","美食","早餐","午餐","晚餐","宵夜","點心","甜點","飲料","果汁","減肥餐","大餐","水果","吃的東西","吃到的東西","好吃","難吃"],
                    ...
                    "hunger":["hunger","食慾","吃","餓","飽","美食沙漠","嘴饞","小鳥胃"],
                    ...
                    "afraid":["afraid","可怕","害怕","恐怖","危險","尾隨","跟蹤","變態","色狼","神經病","車禍","生死一瞬間","人生跑馬燈"],
                    ...
                    "progress":["進度","progress","進步","進展"],
                    "timemanagement":["timemanagement","時間","時間管理"],
