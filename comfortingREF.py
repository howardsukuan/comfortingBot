...
handleSoruceDICT = {"appearance":["appearance","身體","顏值","身高","體重","額頭","髮質","髮際","髮際線","臉","眼袋","眉毛","鼻子","嘴唇","下巴","雙下巴","耳朵","脖子","手","手臂","手肘","胸部","皮膚","皺紋","斑","痣","肚子大","肚子凸","小腹","腰","肚臍","腿","大腿","小腿","膚色","屁股"],
                    ...
                    "colleagueLEI":["colleagueLEI","雷同事","馬屁精","雙面人","小人","偷懶","不做事","被幹掉","被做掉","講壞話","八卦","拍馬屁","來陰的","被弄","組員","分組報告","豬隊友"],
                    "weather":["天氣","weather","大太陽","颳風","下雨","毛毛雨","暴雨","午後雷陣雨","打雷","陰陰的","霧霾","濕氣","酷熱","熱","冷"],
                    "family": ["趕出家門","爸爸","爸","媽媽","媽","父親","母親","哥哥","哥","大哥","姊姊","姊","姐姐","姐","大姊","大姐","弟弟","弟","小弟","妹妹","妹","小妹","親戚","親戚們","外公","外婆","爺爺","奶奶","公公","婆婆","公婆","兒子","女兒","阿公","阿嬤","被家人氣死","被爸媽氣死","氣死"],
                    ...
                    "wit":["頭腦","智商","腦袋","腦子","wit"],
                    "whattodo":["whattodo","如何是好","徬徨","沒有方向","該怎麼辦","該如何是好","可以怎麼做","要怎麼做","該何去何從","該怎麼做","無助","手足無措"],
                    ...
                    "lifequality":["lifequality","好累","忙","聊不起來"],
