...
handleSoruceDICT = {"appearance":["下巴","嘴唇","屁股","手","appearance","皮膚","皺紋","肚子","腿","膚色","臉","身高","額頭","髮質","髮際線","鼻子"],
                    ...
                    "complainToYou":["complain","抱怨","牢騷","問題","東西"],
...
sourceReactionDICT = {"appearance":["大家對外表可能會有一定的要求,但是重點還是在你身上,如果你喜歡這樣的自己,那又何嘗不可?"," 外表只是一時的，只要健康就好","美醜其實都是自己定義的！所以抬頭挺胸，做自信的自己！我相信你可以！","比起皮囊，我更喜歡那裡頭的靈魂。", "不論身心靈各方面，多愛自己一點是基本呀!!!"],
                    ...
                    "colleagueRelation":["真的辛苦你了！看著同事的情況，一定心裡有點不舒服。","真是辛苦了，不被同事理解感覺一定很不好受。只要你現在做事無愧於心，我覺得未來一定會有欣賞你的人出現。","雖然同為工作上的夥伴，但是並不是事事都可以和同事都可以處得這麼好，先暫時緩緩再看看怎麼樣調適心情吧 。"],
                    ...
                    "notDone":["一步一步就可以把手上的事情都做完了！","雖然看似超級多，但一點一點做，一定可以完成的~","我也很討厭事情做不完這種感覺，因為覺得壓力很大啊！但我想和你說，我相信你的能力，按部就班，可以做完的！","手邊事情繁雜的時候真的很不好受，好擔心你，記得要適度休息喔！現在就先喝個水吧！"],
                    ...
                    "progress":["別把自己逼得太緊，適時地放鬆，效果會更好喔。","深陷其中的話無法看出盲點，暫時放自己一個假，再回來的時候一定更有餘裕面對!"]
                    }