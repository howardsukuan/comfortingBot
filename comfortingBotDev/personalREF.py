...
handleSourcePersonalDICT = {
                    ...
                    "toilet":["toilet","拉屎", "廁所", "想大便","肚子痛","脹氣","緊張","想吐","吃壞肚子","胃痛","絞痛","肚子悶","消化不良", "大便"],
                    ...
                    "afraid":["afraid","可怕","害怕","恐怖","危險","尾隨","跟蹤","變態","色狼","神經病","車禍","生死一瞬間","人生跑馬燈","好害怕","受夠","不想再忍", "預防針", "鬼", "蟑螂"],
                    ...
                    "wanttoGotoToilet":["wanttoGotoToilet", "廁所"]
...
sourceReactionPersonalDICT = {
                    ...
                    "nothing":["什麼話都不想說，沒有關係！沒有一定要把自己的心情用文字或是說話來抒發！但我想讓你知道，如果有什麼想要分享的，都可以和我說喔！","沒關係，只要你想分享，我都在！"],
                    ...
                    #生活相關
                     ...
                     "TimeManagement":["是不是覺得時間不夠用很辛苦。重新看一下你的時間表，看看哪些事情可以暫時不用做，多給自己一點時間休息吧!"],
                    "wanttoGotoToilet":["快去！有這個念頭，就要快快去廁所了！"]
                    }